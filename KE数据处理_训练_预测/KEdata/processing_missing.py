...
# 知识图谱
KG_entities = pd.read_csv('KG/entities.csv')
KG_attr = pd.read_csv('KG/entities_attr.csv')
KG_relationships = pd.read_csv('KG/relationships.csv')
...
df_A.to_csv('data/A_Processed.csv', index=False,encoding='utf-8-sig')
df_B.to_csv('data/B_Processed.csv', index=False,encoding='utf-8-sig')