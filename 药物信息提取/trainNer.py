...
import re
import numpy as np
data_dir = 'C:\\Users\\25494\\Desktop\\ner\\data'
...
tokenizer = BertTokenizerFast.from_pretrained('bert-base-chinese',force_download=True)
...
model = AutoModelForTokenClassification.from_pretrained('ckiplab/albert-base-chinese-ner',num_labels=3,
